<?php
  ...
  //Inner join tables
  $data = $DB->query("SELECT reporte.categoria,vereda.vereda,reporte.fecha_hora,reporte.departamento,reporte.municipio,reporte.prioridad,reporte.confidencialidad,reporte.texto, reporte.adjunto, reporte.asunto, usuario.nombre , usuario.apellido,usuario.img 
