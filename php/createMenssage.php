...
$mipdo->bindMas(array("categoria" => $_POST['categoria'], "asunto" => $_POST['asunto'], "lugar" => $_POST['lugar'], "fecha_hora" => $_POST['fecha_hora'], "prioridad" => $_POST['prioridad'], "confidencialidad" => $_POST['confidencialidad'], "texto" => $_POST['texto'], "adjunto" => $_POST['adjunto']));
