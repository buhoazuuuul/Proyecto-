<?php
  ...
  //Inner join tables
  $data = $DB->query("SELECT usuario.img as imgUser, respuesta_mens.id AS respuest_id ,reporte.asunto AS reporte_asunto ,reporte.id AS reporte_id, respuesta_mens.asunto AS asunto_respuesta, usuario.nombre, usuario.apellido, usuario.num_doc,respuesta_mens.fecha_hora AS fecha_respuesta, respuesta_mens.mensaje AS msm_respuesta, 
