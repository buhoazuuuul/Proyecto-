<?php
  ...
  //Inner join tables
  $data = $DB->query("SELECT reporte.fecha_hora,reporte.departamento,reporte.municipio,reporte.prioridad,reporte.confidencialidad,reporte.texto, reporte.adjunto, reporte.asunto, secretario.nombre , secretario.apellido,secretario.img 
