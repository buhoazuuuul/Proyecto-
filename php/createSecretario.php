...
try {
    ...
    $sql = "INSERT INTO secretario (num_doc,tipo_doc,nombre,apellido,dependencia,telefono,email,usuario,pass) 
    VALUES   (:num_doc,:tipo_doc,:nombre,:apellido,:dependencia,:telefono,:email,:usuario,:pass)";
